...
public class UserService {
    ...
    public List<UserProfileDTO> getAllUsers() {
    	   logger.info("Fetching getAllUsers");
    ...
    public UserProfileDTO getUserByAuthUserId(Long authUserId) {
        ...
        return userDtoMappper.userToDto(userRepository.findByAuthUserId(authUserId).orElseThrow(()-> new UserNotFoundException("کاربر با شناسه " + authUserId + " یافت نشد"))  );
}
