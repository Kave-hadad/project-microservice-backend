...
public class GlobalExceptionHandler {
 ...
 public ResponseEntity<String> handleUnreadableMessage(HttpMessageNotReadableException ex) {
     ...
     return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("فرمت ورودی نامعتبر است. لطفاً بررسی کنید.");
 }
 ...
 public ResponseEntity<String> handleMethodNotSupported(HttpRequestMethodNotSupportedException ex) {
     ...
     return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED).body("متد HTTP پشتیبانی نمی‌شود. لطفاً از متد مناسب استفاده کنید.");
 }
 ...
 public ResponseEntity<String> handleGenericException(Exception ex) {
     ...
     return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body("خطای غیرمنتظره‌ای رخ داده است. لطفاً بعداً دوباره تلاش کنید.");
 }
